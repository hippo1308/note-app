...
class User(UserMixin, db.Model):
    ...
    wakatime_api_key = db.Column(db.String(255), nullable=True)  # Store WakaTime API key
...
@login_required
def dashboard():
    # Get notes ordered by pinned status and creation date
...
@login_required
def reminders():
    # Get notes with reminders that are due soon or overdue
    now = datetime.utcnow()
